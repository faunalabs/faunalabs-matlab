...
Time = KINEMATICS.Time(analysisRange);
...
dbpOdba = sqrt(dbpAx.^2 + dbpAy.^2 + dbpAz.^2);
dbpOdav = sqrt(dbpGx.^2 + dbpGy.^2 + dbpGz.^2);
...
DATA = timetable(Time, dbpAx, dbpAy, dbpAz, dbpGx, dbpGy, dbpGz, ...
    dbpOdba, dbpOdav, dPitch, dRoll, dHeading, ...
...
dbFiltLed1 = pow2db(bandpower(DATA.filtLed1));
dbFiltLed2 = pow2db(bandpower(DATA.filtLed2));
dbFiltLed3 = pow2db(bandpower(DATA.filtLed3));
dbFiltLed4 = pow2db(bandpower(DATA.filtLed4));

snr_dbFiltLed2 = dbFiltLed2 - dbFiltLed1;
snr_dbFiltLed3 = dbFiltLed3 - dbFiltLed1;
snr_dbFiltLed4 = dbFiltLed4 - dbFiltLed1;

fprintf('\n==================================================\n\n');
fprintf('Trial: %s | Epoch: %d\n\n', TRIAL.tag, epochChoice);
fprintf('Power:\n');
fprintf('LED1:\tLED2:\tLED3:\tLED4:\n')
fprintf('%3.2f\t%3.2f\t%3.2f\t%3.2f\t\n', dbFiltLed1, dbFiltLed2, ...
    dbFiltLed3, dbFiltLed4);
fprintf('SNR:\n');
fprintf('LED2:\tLED3:\tLED4:\n');
fprintf('%3.2f\t%3.2f\t%3.2f\t%3.2f\t\n', snr_dbFiltLed2, ...
    snr_dbFiltLed3, snr_dbFiltLed4);
fprintf('\n\n');
fprintf('\n==================================================\n');
